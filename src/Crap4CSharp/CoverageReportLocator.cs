...
// report. Pure function, no process execution -- mirrors the ModuleRootResolver / SourceFileFinder /
...
public static class CoverageReportLocator
{
    ...
    public static string? Locate(string projectRoot)
    {
        ...
        // ModuleRootResolver's deliberate anti-glob discipline (dodges the Windows 8.3-shortname quirk; exact
